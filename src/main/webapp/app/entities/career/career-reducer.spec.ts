...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './career.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CAREER_LIST actions', async () => {
    ...
    it('dispatches FETCH_CAREER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CAREER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CAREER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CAREER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CAREER actions', async () => {
      const expectedActions = [
        {
