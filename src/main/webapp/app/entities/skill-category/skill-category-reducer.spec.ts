...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SKILLCATEGORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_SKILLCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SKILLCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SKILLCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SKILLCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SKILLCATEGORY actions', async () => {
      const expectedActions = [
        {
