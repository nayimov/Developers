    ...
    <Row>
      <Col md="8">
        <h2 data-cy="skillCategoryDetailsHeading">
          <Translate contentKey="developersApp.skillCategory.detail.title">SkillCategory</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dd>{skillCategoryEntity.category}</dd>
        </dl>
        <Button tag={Link} to="/skill-category" replace color="info" data-cy="entityDetailsBackButton">
        ...
        &nbsp;
        <Button tag={Link} to={`/skill-category/${skillCategoryEntity.id}/edit`} replace color="primary">
