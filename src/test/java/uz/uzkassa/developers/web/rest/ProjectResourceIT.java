...
import uz.uzkassa.developers.repository.ProjectRepository;
...
class ProjectResourceIT {
    ...
    public static Project createEntity(EntityManager em) {
        Project project = new Project().name(DEFAULT_NAME).url(DEFAULT_URL);
        return project;
    }
    ...
    public static Project createUpdatedEntity(EntityManager em) {
        Project project = new Project().name(UPDATED_NAME).url(UPDATED_URL);
        return project;
    }
    ...
    void putExistingProject() throws Exception {
        ...
        updatedProject.name(UPDATED_NAME).url(UPDATED_URL);
    ...
    void fullUpdateProjectWithPatch() throws Exception {
        ...
        partialUpdatedProject.name(UPDATED_NAME).url(UPDATED_URL);
