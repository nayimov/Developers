...
export const CareerDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(careerEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="developersApp.career.delete.question">
        <Translate contentKey="developersApp.career.delete.question" interpolate={{ id: careerEntity.id }}>
...
export default CareerDeleteDialog;
